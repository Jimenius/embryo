...
from embryo.brain.central.REDQ import REDQCentral
...
def main():
    ...
    central = REDQCentral(network=None, target_update_frequency=target_update_freq, critic_update_frequency=20, ensemble_size=10, gamma=gamma)
